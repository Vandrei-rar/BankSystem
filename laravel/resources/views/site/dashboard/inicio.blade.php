    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="coluna" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="inicio.html" class="list-group-item list-group-item-action bg-transparent second-text active"><i
                        class="fa fa-home"></i> Inicio</a>

                <a href="saldo.html" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                    class="fa fa-money"></i> Saldo</a>

                <a href="transferencia.html" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i 
                    class="fa fa-exchange" aria-hidden="true"></i> Transferência</a>

                <a href="dadosdaconta.html" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
